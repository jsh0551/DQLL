...
python train.py gpus='1' backbone="CSPDarknet-m" num_epochs=50 exp_id="CSPDarknet-m" use_amp=True val_intervals=1 data_num_workers=8 batch_size=24 load_model="./weights/yolox-m.pth"
