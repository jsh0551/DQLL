...
def getInfo(ipath,data):
    ...
    cons, hier = cv2.findContours(temp, cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
...
DATAROOT = r"C:/Users/zxsxp/Desktop/work/DQLL/data/TuSimple"
...
print(len(faileList), len(namelist), len(DRL_list), DRLcount)
